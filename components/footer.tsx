      ...
      <div className="page-wrap grid gap-8 sm:gap-10 md:grid-cols-12">
        ...
        <nav className="md:col-span-3" aria-label="Footer">
          ...
          <ul className="mt-3 space-y-2 sm:mt-4">
            {nav.map((item) => (
              <li key={item.href}>
                <a href={item.href} className="text-[0.95rem] text-navy hover:text-muted">
                  {item.label}
                </a>
              </li>
            ))}
        ...
        <div className="min-w-0 md:col-span-4">
          ...
          <ul className="mt-3 space-y-2 break-words text-[0.92rem] text-navy sm:mt-4 sm:text-[0.95rem]">
            <li>
              <a href={site.contact.emailHref} className="hover:text-muted">
                {site.contact.email}
              </a>
            </li>
            <li>
              <a href={site.contact.phoneHref} className="hover:text-muted">
                {site.contact.phone}
              </a>
            </li>
